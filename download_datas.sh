...
# Gong-Surakav
curl https://dart.cse.kau.se/popets-2026.1-ephemeral-defs-paper-artifacts/gong-surakav-undefended-cw.tar.gz
tax -xvzf gong-surakav.tar.gz
cp ../gong-surakav_rename.sh gong-surakav/
cd gong-surakav
./gong-surakav_rename.sh
