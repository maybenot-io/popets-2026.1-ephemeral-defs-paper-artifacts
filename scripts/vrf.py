...
CROSS_VALIDATION_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cross-validation/")
...
ap.add_argument("-c", required = True, type = int, default = 100,
    help = "the number of monitored videos (=classes)")
ap.add_argument("-p", type = int, default = 10,
    help = "the number of offsets")
ap.add_argument("-s", required = True, type = int, default = 10,
...
ap.add_argument("--epochs", required = False, default = EPOCH,
    help = "epochs, ignored")
ap.add_argument("--patience", required = False, default = EPOCH,
    help = "patience, ignored")
ap.add_argument(
    "-f", required=False, type=int, default=0, help="the fold number, offset to the cross file"
)
ap.add_argument(
    "--seed", required=False, type=int, default=-1, help="seed for reproducibility"
)

ap.add_argument("--packets", required = False, default = False,
    action = "store_true", help = "count packets instead of bytes")
...
def split_dataset(
    websites, subpages, samples, fold):
