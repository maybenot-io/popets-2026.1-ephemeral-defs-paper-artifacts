...
/// From Syverson et al. "Onion-Location Measurements and Fingerprinting" paper
/// under submission. The traces are the first 30 cells of general and rend
/// circuits. We ignore hsdir and intro circuits, because they will always be
/// trivially distinguishable by their relative short lengths. While 30 cells is
/// too much for the handshake, it is a comfortable margin for circuit
/// fingerprinting for general, rend, hsdir, and intro circuits using DF.
            ...
            Traces::Custom { root, bytes } => {
                {
                    ...
                    visit_dirs(root_path, &mut file_paths, bytes.0 as u64, bytes.1 as u64)?;
